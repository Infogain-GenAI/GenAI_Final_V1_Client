          ...
          <Container>
            <div className="page-wrapper">
              <div className="page-title">
                <h1 className="h2">About GenAI Assistants</h1>
              </div>
              <div className="contentContainer">
                <p>
                  GenAI Assistants are advanced AI systems designed to help you
                  with a wide range of tasks. We are versatile, adaptable, and
                  capable of learning from experience.
                </p>
                <p>Here are some key features of genAI Assistants:</p>
                <ul>
                  <li>
                    We can perform complex calculations and data analysis.
                  </li>
                  <li>
                    We can help with customer service by answering inquiries and
                    providing information.
                  </li>
                  <li>
                    We can provide detailed information about products on an
                    ecommerce platform.
                  </li>
                  <li>
                    We can help you understand complex concepts by providing
                    clear and concise explanations.
                  </li>
                </ul>
                <p>
                  Our GenAI Assistants are constantly learning and improving,
                  and we're excited to see how We can help you!
                </p>
                <p>
                  <Link
